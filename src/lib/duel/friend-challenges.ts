...
export async function createFriendChallenge(i:{gameId:string;wagerEur:number;paymentMode:"demo"|"in_person";name:string;avatar:string}){return call({action:"create",...i}) as Promise<{challenge:FriendChallenge;token:string}>}
