...
function DirectionGame() {
  ...
  return (
    <main className="mx-auto flex h-[100dvh] w-full max-w-md flex-col overflow-hidden overscroll-none bg-background">
      ...
      >
        <OpponentOutBanner opponentName={activeMatch.opponent.username} opponentScore={opponentOut} playerScore={destroyed} wagerEur={wagerEur} outAfterMs={1100 + opponentOutMs} label="arrows" />
